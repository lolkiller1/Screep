...
module.exports = {
	...
	run2(creep){
		...
		if (creep.memory.status == "harvesting") {
			...
			var towers = creep.room.find(FIND_MY_STRUCTURES, {filter: function(object) {return object.structureType == STRUCTURE_TOWER && object.store && object.store.getFreeCapacity(RESOURCE_ENERGY) > 0}})
